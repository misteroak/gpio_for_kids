            ...
            <Card className="my-3 text-center">
                ...
                <ListGroup>
                    <ListGroupItem>
                        ...
                        <Button className="mx-3 px-3" size="lg" variant="success" onClick={(e, id) => this.props.onAcitonClick(e, "G")}><FontAwesomeIcon icon={faLightbulb} /> <span>Green</span></Button>
                        <Button className="mx-3 px-3" size="lg" variant="primary" onClick={(e, id) => this.props.onAcitonClick(e, "B")}><FontAwesomeIcon icon={faLightbulb} /> <span>Blue</span></Button>
